...
SHOW_START_SCREEN:
    ...
    LD HL, START_SCREEN_DATA		; Text
    LD DE, START_SCREEN_DATA_END-START_SCREEN_DATA
...
SHOW_START_LEVEL:
    ...
    CALL BCD_PRINT_HL_A
    LD HL, START_LEVEL_STR_COLOR
    LD DE, START_LEVEL_STR_COLOR_END-START_LEVEL_STR_COLOR
    CALL BTX_PRINT_HL_DE
    RET

CHANGE_START_LEVEL:
    CALL CLSC
    LD HL, CHANGE_SCREEN_DATA		; Text
    LD DE, CHANGE_SCREEN_DATA_END-CHANGE_SCREEN_DATA
    CALL BTX_PRINT_HL_DE
